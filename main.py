...
if __name__ == "__main__":
    ...
    parser.add_argument('-np', '--NumPerm', default=100, type = int, help='Number of TTP row permutations')
    parser.add_argument('-n', '--Normalize', default=0, type = int, choices=[0, 1], help='Calculated NTTP or TTP, 1 for NTTP')
    parser.add_argument('-nb', '--NumBase', default=100, type = int, help='Number of TTP baseline realizations')
